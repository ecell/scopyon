...
#	palm.set_ADConverter(bit=14, offset=2000, fullwell=800000)
	...
	# Output data
	palm.set_OutputData(image_file_dir='./numpys_palm_aggr05_bleach')
	#palm.set_OutputData(image_file_dir='./numpys_palm_aggr05_blink')

	# Input data
	palm.set_InputData('/home/masaki/bioimaging_4public/data_palm_aggr05_bleach', start=t0, end=t1, observable="A")
	#palm.set_InputData('/home/masaki/bioimaging_4public/data_palm_aggr05_blink', start=t0, end=t1, observable="A")
	...
	#create.rewrite_InputData(output_file_dir='./data_palm_01000A')
