...
#	# Output data
#	flip.set_OutputData(image_file_dir='./numpys_flip_001000A')
#	flip.set_OutputData(image_file_dir='./numpys_flip_019656A')

	# Input data
	#flip.reset_InputData('/home/masaki/wrk/spatiocyte/models/beads_3D_000100A', start=t0, end=t1, observable="A")
	#flip.reset_InputData('/home/masaki/wrk/spatiocyte/models/beads_3D_019656A', start=t0, end=t1, observable="A")
	flip.reset_InputData('/home/masaki/wrk/spatiocyte/models/beads_3D_080000A', start=t0, end=t1, observable="A")
	...
	#create.rewrite_InputData(output_file_dir='./data_flip_000100A_bleach')
	#create.rewrite_InputData(output_file_dir='./data_flip_019656A_bleach')
	#create.rewrite_InputData(output_file_dir='./data_flip_019656A_blink')
	create.rewrite_InputData(output_file_dir='./data_flip_010000A_bleach')
