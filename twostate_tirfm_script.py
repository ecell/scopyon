...
#	tirfm.set_ADConverter(bit=16, offset=100, fullwell=30000)
	...
	#tirfm.set_OutputData(image_file_dir='./images_twostate_model_cmos')
	tirfm.set_OutputData(image_file_dir='./images_twostate_model_emccd')

	### Input data
	tirfm.set_InputData('/home/masaki/ecell3/latest/data/csv/twostate_model', start=t0, end=t1)
