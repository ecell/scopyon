...
def main():
    ...
    img1 = scopyon.base.form_image(inputs[: 200], config=config, rng=rng)
    img2 = scopyon.base.form_image(inputs[150: ], config=config, rng=rng)

    img = scopyon.image.Image(red=img1, green=img2)
