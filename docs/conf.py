...
latex_documents = [
    (master_doc, 'scopyon.tex', 'scopyon Documentation',
     'Watabe Masaki', 'manual'),
]
...
man_pages = [
    (master_doc, 'scopyon', 'scopyon Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'scopyon', 'scopyon Documentation',
     author, 'scopyon', 'One line description of project.',
     'Miscellaneous'),
]
