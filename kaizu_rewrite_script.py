...
def test_epifm(t0, t1) :
	...
	epifm.set_Detector(detector='EMCCD', image_size=(512,512), pixel_length=16e-6, exposure_time=0.150, \
				focal_point=(0.00,0.5,0.5), QE=0.92, readout_noise=100, emgain=300)
	epifm.set_ADConverter(bit=16, offset=2000, fullwell=800000)

	# Input data
	#csv_dir = '/home/masaki/wrk/spatiocyte/models/Kaizu/data/ST'
	csv_dir = '/home/masaki/wrk/spatiocyte/models/Kaizu/data/S2'
	...
	#create.rewrite_InputFile(output_file_dir='./data_kaizu/data_pb/ST_120ms')
	create.rewrite_InputFile(output_file_dir='./data_kaizu/data_pb/S2_150ms')
