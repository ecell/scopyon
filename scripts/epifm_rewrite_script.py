...
def test_epifm(t0, t1) :
    ...
    epifm = EPIFMConfigs()
    epifm.set_LightSource(source_type='LASER', wave_length=561, flux_density=20, angle=0)
...
#       epifm.set_ADConverter(bit=16, offset=100, fullwell=30000)
    ...
    epifm.set_Detector(detector='EMCCD', image_size=(512,512), pixel_length=16e-6, exposure_time=0.1, \
                            focal_point=(0.0,0.65,0.5), QE=0.92, readout_noise=100, emgain=300)
    epifm.set_ADConverter(bit=16, offset=2000, fullwell=800000)

#       # Output data
#       epifm.set_OutputData(image_file_dir='./numpys_epifm_01000A')

    # Input data
    csv_dir = '/home/masaki/wrk/spatiocyte/models/Hiroshima/data_HRG-ErbB/SM/csv/TEST'
    epifm.reset_InputData(csv_dir, start=t0, end=t1, observable="r1")
    ...
    create.rewrite_InputData(output_file_dir='./data_epifm_TEST_00deg')
