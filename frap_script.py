...
#	# Output data
	frap.set_OutputData(image_file_dir='./numpys_frap_080000A_bleach')
	#frap.set_OutputData(image_file_dir='./numpys_frap_019656A_bleach')
	#frap.set_OutputData(image_file_dir='./numpys_frap_019656A_blink')
	#frap.set_OutputData(image_file_dir='./numpys_frap_000100A_bleach')

	# Input data
	#frap.set_InputData('/home/masaki/wrk/spatiocyte/models/beads_3D_019656A', start=t0, end=t1, observable="A")
	frap.set_InputData('/home/masaki/bioimaging_4public/data_frap_080000A_bleach', start=t0, end=t1, observable="A")
	#frap.set_InputData('/home/masaki/bioimaging_4public/data_frap_019656A_bleach', start=t0, end=t1, observable="A")
	#frap.set_InputData('/home/masaki/bioimaging_4public/data_frap_019656A_blink', start=t0, end=t1, observable="A")
	#frap.set_InputData('/home/masaki/bioimaging_4public/data_frap_000100A_bleach', start=t0, end=t1, observable="A")
	...
	#create.rewrite_InputData(output_file_dir='./data_frap_19656A_bleach')
	#create.rewrite_InputData(output_file_dir='./data_frap_19656A_blink')
